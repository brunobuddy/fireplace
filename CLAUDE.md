...
comment, Spark answer) pushes a notification to the **other** subscribed
family members — never to the person who acted. Standard PWA push (VAPID via
`web-push`); a bell toggle in the app header manages the per-device
subscription. Works on the installed Android PWA and desktop browsers.
...
Current baseline: typecheck ✅ · lint ✅ · unit 140+120 ✅ · e2e 60 ✅ · build ✅.
